...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cream-light dark:bg-gray-950">
      ...
      <div className="fixed bottom-6 right-6 z-50 sm:right-8 lg:right-12">
        <div className="flex items-center gap-5 rounded-full bg-white/95 px-6 py-3.5 shadow-soft-lg ring-2 ring-dusty-rose/50 backdrop-blur-md dark:bg-gray-900/95 dark:ring-gray-700/30">
          <a
            href="tel:+1234567890"
            aria-label="Call (123) 456-7890"
            className="flex cursor-pointer touch-manipulation items-center gap-2.5 text-base font-medium text-cream-dark transition-colors hover:text-coral dark:text-cream"
          >
